...
import logoBiru from '../../../assets/images/logo-biru.jpg'
    ...
    <React.Fragment>
      <div className="m-header">
        ...
        {/* <Link to="#" className="b-brand">
          <img id="main-logo" src={logoBiru} alt="" className="logo" />
          <p>CV. Biru Air Minum</p>

        </Link> */}
        <figure class="text-center pt-3 mt-3 px-4">
    <p>PT. Air Minum Biru Semesta Abadi</p>
