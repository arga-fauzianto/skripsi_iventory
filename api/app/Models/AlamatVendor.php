...
class AlamatVendor extends Model
{
    protected $table            = 'alamat_vendor';
    protected $primaryKey       = 'id_alamat_vendor';
    protected $useAutoIncrement = true;
    protected $returnType       = 'array';
    protected $useSoftDeletes   = false;
    protected $protectFields    = true;
    protected $allowedFields    = ['id_vendor', 'street', 'city', 'state', 'postal_code'];
    ...
    protected $validationMessages   = [
        'id_vendor'   => [
            ...
            'integer'  => 'ID Vendor harus berupa angka',
        ],
        'street'      => [
